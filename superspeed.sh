...
preinfo() {
	...
	echo "       节点更新: 2026/06/14  | 脚本更新: 2026/06/14"
	echo "——————————————————————————————————————————————————————————"
}
...
runtest() {
	...
	if [[ ${selection} == 1 ]]; then
		...
		#***
		 ...
		 speed_test '5084' '广东广州' '联通'
		 speed_test '24447' '上海５Ｇ' '联通'
		 speed_test '43752' '北京' '联通'
		 speed_test '16794' '江苏南京' '联通'
		 speed_test '1185' '吉林长春' '联通'
